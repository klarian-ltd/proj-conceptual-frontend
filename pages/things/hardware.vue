<template>
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <div>
                <UBadge color="primary" variant="outline" class="flex justify-center rounded-lg ml-4">
                    <UTable ref="table" v-model:global-filter="globalFilter" v-model:pagination="pagination" :data="data" :columns="columns" :pagination-options="{
                        getPaginationRowModel: getPaginationRowModel()}" class="w-full" />
                </UBadge>
            </div>
